...
class QWEN3_32B():
    ...
    def find_research_prompt(self, user_text):
        system_message = ('من از کاربرم یک متن میگیریم که فک میکنم در اون متن یک موضوع نوشته شده برای اراعه یک تحقیق به کاربرم درباره اون موضوع'
    ...
    def researching(self, user_text):
        research_prompt = self.find_research_prompt(user_text)
q3 = QWEN3_32B()
print(q3.researching('ایران'))
